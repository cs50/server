...
# Install Passenger
RUN apt install --no-install-recommends --yes dirmngr gnupg apt-transport-https ca-certificates && \
    ...
    curl -LJ -o /tmp/v0.34.tar.gz https://github.com/openresty/headers-more-nginx-module/archive/v0.34.tar.gz && \
